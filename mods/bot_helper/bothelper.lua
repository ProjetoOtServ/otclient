...
-- =============================================================
-- FOOTER DINAMICO — Status e hotkey por aba
-- =============================================================
...
-- =============================================================
-- TOGGLE DE STATUS POR ABA — @onClick do lblHelperStatusVal
-- =============================================================
...
BotHelper.Healing.spells  = {}   -- {text='', pct=80}  × 3
BotHelper.Healing.potions = {}   -- {itemId=0, pct=60, isMana=false} × 3
...
-- =============================================================
-- Carrega g_settings → UI (UIItems + SpinBoxes)
-- =============================================================
...
-- =============================================================
-- MOTOR DE CURA — ciclo 150ms com cascata de prioridade
-- =============================================================
...
function BotHelper.startHealingEngine()
  ...
  BotHelper.healingCycle = cycleEvent(function()
    ...
    -- ── SPELLS (cascata: menor pct configurado que foi atingido) ──────
...
-- =============================================================
-- CONTEXT MENU — SPELL SLOTS (direito no icone)
-- =============================================================
...
-- =============================================================
-- CONTEXT MENU — POTION SLOTS (direito no UIItem)
-- =============================================================

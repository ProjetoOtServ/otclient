...
-- Categorias Reais
local CATEGORIES = {
  {name = "Walls", items = {1281, 1282, 1284, 1286, 1287, 5153, 5152, 5154, 1283, 17195, 17196, 17197, 17198, 17199, 17200, 17135, 17098, 17138}},
  {name = "Windows", items = {6437, 6438, 9349, 9350, 1734, 1735, 9309, 9310, 9311, 9312, 9313, 9314, 9315, 9331, 9330, 9329, 9328, 17164, 17166, 17695, 17694}},
  {name = "Doors", items = {1641, 1639, 17563, 17572}},
  {name = "Floors", items = {408, 409, 429, 417, 17516, 17517, 17518, 16489, 16488, 16487}},
  {name = "Furniture", items = {17388, 17389, 17390}},
  {name = "Stairs", items = {433, 1948}},
  {name = "Hangables", items = {2907, 2909, 9517, 9516, 2598, 2931, 2929, 2605}},
  {name = "Roofs", items = {1165, 1160, 1159, 1164, 1166, 1161, 1158, 1157, 1162, 1163}},
